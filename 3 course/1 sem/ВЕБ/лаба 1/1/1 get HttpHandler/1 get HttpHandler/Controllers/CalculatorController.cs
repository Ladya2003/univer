...
namespace _1_get_HttpHandler.Controllers
{
    ...
    public class CalculatorController : ControllerBase
    {
        ...
        [HttpPost]  // 4 задание
        [Route("add")]
        public IActionResult Add([FromBody] NumbersRequest request) // одним параметром забрать
        {
        ...
        {
            var filePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "calculator.html"); // преобр в path
