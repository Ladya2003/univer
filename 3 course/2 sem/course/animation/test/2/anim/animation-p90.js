...
lib.ssMetadata = [
		...
		{name:"animation_p90_atlas_2", frames: [[802,569,979,209],[1569,0,425,213],[0,0,1567,567],[0,569,800,572],[1783,706,245,96],[1783,215,153,489],[802,1142,472,126],[802,780,480,360],[1284,780,480,360],[1892,804,114,166],[1996,0,33,33],[1766,960,114,166],[1938,319,85,73],[1569,215,154,154],[1938,215,92,102],[1766,804,124,154],[1569,371,148,148],[1882,972,117,148]]}
];
...
(lib.animationp90 = function(mode,startPosition,loop) {
	...
	this.actionFrames = [0,1,421,472,1008,1044,1088,1139];
	this.streamSoundSymbolsList[0] = [{id:"тест2onlineaudioconvertercom",startFrame:0,endFrame:486,loop:1,offset:0}];
	this.streamSoundSymbolsList[421] = [{id:"p90reload2",startFrame:421,endFrame:1411,loop:1,offset:0}];
	...
	this.frame_421 = function() {
		var soundInstance = playSound("p90reload2",0);
		this.InsertIntoSoundStreamData(soundInstance,421,1411,1);
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(420).call(this.frame_421).wait(51).call(this.frame_472).wait(536).call(this.frame_1008).wait(36).call(this.frame_1044).wait(44).call(this.frame_1088).wait(51).call(this.frame_1139).wait(384));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/animation_p90_atlas_1.png?1710685840918", id:"animation_p90_atlas_1"},
		{src:"images/animation_p90_atlas_2.png?1710685840919", id:"animation_p90_atlas_2"},
		{src:"sounds/тест3onlineaudioconvertercom.mp3?1710685840952", id:"тест3onlineaudioconvertercom"},
		{src:"sounds/тест2onlineaudioconvertercom.mp3?1710685840952", id:"тест2onlineaudioconvertercom"},
		{src:"sounds/тест4.mp3?1710685840952", id:"тест4"},
		{src:"sounds/p90shoot.mp3?1710685840952", id:"p90shoot"},
		{src:"sounds/p90reload2.mp3?1710685840952", id:"p90reload2"},
		{src:"sounds/тест5.mp3?1710685840952", id:"тест5"}
	],
	preloads: []
};
